  ...
  return (
    <>
      <footer className={props.className}>
        <div className="bg-black-900 flex flex-col h-[437px] md:h-auto items-start justify-start max-w-[1773px] pb-[50px] pt-[100px] md:px-10 sm:px-5 px-[163px] w-full">
          <div className="flex md:flex-col flex-row md:gap-10 gap-[355px] items-start justify-between w-full">
