...
const DesktopSix1Page = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-questrial items-start justify-end mx-auto w-full">
        ...
        <div className="flex flex-col gap-10 h-[899px] md:h-auto items-start justify-start max-w-[1166px] md:ml-[0] ml-[17px] mt-[77px] md:px-5 w-full">
        ...
        <div className="flex flex-col items-end md:px-10 sm:px-5 px-[67px] w-full">
...
export default DesktopSix1Page;
